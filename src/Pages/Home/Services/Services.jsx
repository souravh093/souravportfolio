    ...
    <div className="mt-20">
      <Container>
        ...
        <div className="grid grid-cols-3 mt-16 gap-10">
          <div className="bg-[#091530] rounded-md  p-10">
          ...
          <div className="bg-[#091530] rounded-md  p-10">
            ...
            <p className="text-gray-200 my-5">
              Optimizing React applications for enhanced speed and performance,
              ensuring smooth interactions and minimal load times
            </p>
            <Link className="text-gray-200 flex items-center gap-2">
              Learn More <BsArrowUpRight />
            </Link>
